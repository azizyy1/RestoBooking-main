...
public class RegisterModel : PageModel
{
    ...
    public class InputModel
    {
        ...
        [StringLength(100, ErrorMessage = "{0} doit contenir au moins {2} et au maximum {1} caractères.", MinimumLength = 6)]
    ...
    public async Task<IActionResult> OnPostAsync(string? returnUrl = null)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("Nouvel utilisateur créé avec un mot de passe.");
